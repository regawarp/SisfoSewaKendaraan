...
$objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue('A1', 'LAPORAN DATA KLIEN BELUM LUNAS')
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Laporan Klien Blm Lunas');
...
header('Content-Disposition: attachment;filename="LaporanKlienBelumLunas' . $tanggal_awal . '-' . $tanggal_akhir . '.xlsx"');
